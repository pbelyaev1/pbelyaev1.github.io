...
(function () {
  ...
  /* ---------------------------------------------------------------------- */
  const SHELLS = {
    /* Пока единственный: вырезан из общей сцены. Как появится отдельная
       картинка корпуса на нейтральном фоне — добавится сюда же. */
    scene_wood: {
      name: 'кремовый (в сцене)',
      type: 'scene',                       // корпус и фон одной картинкой
    ...
    /* ПРОБНЫЙ корпус из отдельных частей — только чтобы проверить раздельный
       режим до прихода настоящих картинок. Убрать, когда появится настоящий. */
    test_parts: {
      name: 'пробный (отдельно)',
      type: 'parts',
      image: 'resources/img/skins/shell_test.png',
      w: 657, h: 955,
      size: 0.78, offsetY: 0.5,
      screen:  { x: 0.21157, y: 0.21466, w: 0.57686, h: 0.39686 },
      radius:  0.02,
      buttons: [
        { x: 0.17233, y: 0.72170, w: 0.21699, h: 0.14928 },
        { x: 0.39151, y: 0.74683, w: 0.21699, h: 0.14928 },
        { x: 0.61068, y: 0.72170, w: 0.21699, h: 0.14928 },
      ],
      light: 'left-top',
    },
  };
  ...
  const BACKGROUNDS = {
    ...
    test_wood: { name: 'пробное дерево', image: 'resources/img/skins/bg_test.jpg', light: 'left-top' },
  };
