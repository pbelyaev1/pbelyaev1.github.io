...
(function () {
  ...
  const SHELLS = {
    cream: {
      ...
      screen:  { x: 0.23402, y: 0.29389, w: 0.53679, h: 0.42462 },
      ...
      shadow:  { image: 'resources/img/skins/shadow_cream.png', pad: 0.20024 },
      buttons: [
        { x: 0.26519, y: 0.79395, w: 0.13549, h: 0.10580 },   // левая
        { x: 0.43165, y: 0.83158, w: 0.13549, h: 0.10305 },   // средняя
        { x: 0.59932, y: 0.79649, w: 0.13549, h: 0.10168 },   // правая
      ],
...
`;
  ...
  function build() {
    ...
    /* Аварийный выход без меню: три быстрых касания по фону возвращают
       обычный корпус. Нужен на случай, если что-то не отрисовалось и до
