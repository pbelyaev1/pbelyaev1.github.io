...
(function () {
  ...
  const SCENES = {
    ussr: {
      name: 'наши 90-е',
      kind: 'scene',
      image: 'resources/img/skins/scene_ussr.jpg',
      w: 941, h: 1672,
      quad: [[311, 827], [628, 827], [628, 1136], [311, 1136]],
      radius: 0.030,
      buttons: [
        { x: 0.31692, y: 0.69571, w: 0.10261, h: 0.05775 },
        { x: 0.44869, y: 0.71126, w: 0.10261, h: 0.05775 },
        { x: 0.58028, y: 0.69581, w: 0.10406, h: 0.05694 },
      ],
    ...
    cyber: {
      name: 'киберпанк',
      kind: 'scene',
      image: 'resources/img/skins/scene_cyber.jpg',
      w: 850, h: 1850,
      quad: [[238, 760], [607, 760], [607, 1118], [238, 1118]],
      radius: 0.030,
      buttons: [
        { x: 0.27059, y: 0.62054, w: 0.12000, h: 0.05514 },
        { x: 0.43647, y: 0.62649, w: 0.12000, h: 0.05514 },
        { x: 0.60118, y: 0.62108, w: 0.12000, h: 0.05514 },
      ],
      zooms: [1.00, 0.91, 1.15],
    },
    jungle: {
      name: 'джунгли',
      kind: 'scene',
      image: 'resources/img/skins/scene_jungle.jpg',
      w: 850, h: 1850,
      quad: [[259, 882], [589, 882], [590, 1208], [259, 1208]],
      radius: 0.030,
      buttons: [
        { x: 0.29118, y: 0.67243, w: 0.12941, h: 0.05946 },
        { x: 0.43647, y: 0.68514, w: 0.12941, h: 0.05946 },
        { x: 0.57412, y: 0.67243, w: 0.12941, h: 0.05946 },
      ],
      zooms: [1.00, 0.81, 1.15],
    },
    office: {
      name: 'рабочий стол',
      kind: 'scene',
      image: 'resources/img/skins/scene_office.jpg',
      w: 850, h: 1850,
      quad: [[252, 846], [600, 846], [600, 1192], [252, 1192]],
      radius: 0.030,
      buttons: [
        { x: 0.28264, y: 0.65719, w: 0.13120, h: 0.06616 },
        { x: 0.42960, y: 0.67036, w: 0.14080, h: 0.06469 },
        { x: 0.58489, y: 0.65738, w: 0.14080, h: 0.06469 },
      ],
      zooms: [1.00, 0.86, 1.15],
    },
    forest: {
    ...
    space: {
      ...
      w: 853, h: 1844,
      quad: [[251, 802], [609, 803], [609, 1155], [250, 1154]],
      radius: 0.030,
      buttons: [
        { x: 0.27555, y: 0.64379, w: 0.11479, h: 0.05679 },   // левая
        { x: 0.43967, y: 0.65916, w: 0.11479, h: 0.05531 },   // средняя
        { x: 0.60455, y: 0.64408, w: 0.11798, h: 0.05458 },   // правая
      ],
      /* экран занимает 42 % ширины кадра: при 100 % он штатного размера, но
         кадр немного подрезается; 88 % — весь кадр целиком */
    ...
    leaves: {
      ...
      w: 904, h: 1739,
      quad: [[257, 729], [649, 730], [649, 1106], [256, 1105]],
      radius: 0.030,
      buttons: [
        { x: 0.28761, y: 0.64922, w: 0.10398, h: 0.05405 },   // левая
        { x: 0.44303, y: 0.66849, w: 0.10398, h: 0.05405 },   // средняя
        { x: 0.60232, y: 0.65152, w: 0.10398, h: 0.05405 },   // правая
      ],
      /* экран занимает 43 % ширины фотографии — при 100 % он выходит штатного
         размера и при этом видно всю сцену, увеличивать её не нужно */
...
`;
  ...
  function zoomLabel() {
    ...
    if (Math.abs(got - want) <= 2) return want + '%';
    /* меньше заказанного — упёрлись в края телефона, так и пишем; больше
       заказанного — фотографии пришлось растянуться, чтобы закрыть экран
       без щелей, и это не предел, а просто вышло крупнее */
    return got + (got < want ? '% (предел)' : '%');
  }
