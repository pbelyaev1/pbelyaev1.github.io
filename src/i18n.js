...
/* ============================================================================
   Русские имена для новых питомцев.

   В оригинале имя собирается из английского списка и «тамагочи»-окончания
   (-tchi, -chu, -chi, -ko). Здесь то же самое, но из русских основ.
...
(function () {
  ...
  const STEMS = [
    'Ада','Алиса','Ася','Бася','Буся','Валя','Варя','Вася','Вера','Веста',
    'Вишня','Влада','Глаша','Гоша','Груша','Даша','Дина','Дуся','Женя','Заря',
    'Зефира','Зина','Зоя','Ива','Ирис','Ириска','Искра','Кася','Кися','Клава',
    'Клюква','Кроха','Ксюша','Лада','Лана','Лапа','Лика','Луша','Люся','Ляля',
    'Малина','Маруся','Марта','Мася','Мила','Мира','Морошка','Мура','Муся','Найда',
    'Ната','Нюша','Няша','Оля','Пава','Плюша','Поля','Проша','Пряня','Пуша',
    'Пуфа','Пышка','Рада','Роса','Рыся','Сима','Слава','Снежа','Соня','Стеша',
    'Тася','Тиша','Тома','Топа','Тося','Тучка','Тяпа','Умка','Устя','Фася',
    'Феня','Фима','Фрося','Хома','Чара','Шуня','Шура','Юля','Яна','Ярка',
    'Ягодка','Ватруша','Бублик','Кекса','Тортя','Зефи','Пуся','Пончик','Бусина','Нюра',
    'Тимоша','Гриша','Митя','Яша','Сеня','Тёма','Филя','Боря','Кузя','Тошка'
  ];
